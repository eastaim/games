...
이 디렉터리는 게임 포털(games) 프로젝트의 기획/설계/작업 문서를 모아둔 곳입니다.
...
- [02-architecture](02-architecture/) — 설계 문서, ADR
  ...
  - [adr-001-iframe-포털-구조.md](02-architecture/adr-001-iframe-포털-구조.md)
  - [adr-002-플레이어-신원-공유.md](02-architecture/adr-002-플레이어-신원-공유.md) —
    게임이 만든 `player` 쿠키를 포털이 함께 쓰는 이유
- [03-notes](03-notes/) — 작업 메모
  - [2026-09-12-포털-초기-구현.md](03-notes/2026-09-12-포털-초기-구현.md)
